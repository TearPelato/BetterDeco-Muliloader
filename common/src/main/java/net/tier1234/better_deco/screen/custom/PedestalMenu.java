...
import net.tier1234.better_deco.blockentity.PedestalBlockEntity;
...
public class PedestalMenu extends AbstractContainerMenu {
    ...
    public boolean stillValid(Player player) {
        ...
        stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.STONE_PEDESTAL.get())
        ||
        stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.DIORITE_PEDESTAL.get())
        ||
        stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.GRANITE_PEDESTAL.get())
        ||
        stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.DEEPSLATE_PEDESTAL.get())

        ||
        stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.DEEPSLATE_TILE_PEDESTAL.get())
        ||
        stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.BLACKSTONE_PEDESTAL.get());
