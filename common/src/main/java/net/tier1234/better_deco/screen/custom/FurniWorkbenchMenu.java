...
public class FurniWorkbenchMenu extends AbstractContainerMenu {

    private final ContainerLevelAccess access;
    private final Player player;
    private final Level level;
    private final FurniWorkbenchBlockEntity blockEntity;
    ...
    public FurniWorkbenchMenu(int id, Inventory inventory, Level level, BlockPos pos, SimpleContainer outputContainer) {
        ...
        this.level = level;
        this.blockEntity = level.getBlockEntity(pos) instanceof FurniWorkbenchBlockEntity entity ? entity : null;
    ...
    public FurniWorkbenchMenu(int id, Inventory inventory, Level level, BlockPos pos) {
        this(id, inventory, level, pos, new SimpleContainer(1));
    }

    public FurniWorkbenchMenu(int id, Inventory inventory, FriendlyByteBuf buf) {
        this(id, inventory, inventory.player.level(), buf.readBlockPos(), new SimpleContainer(1));
    }

    public FurniWorkbenchMenu(int id, Inventory inventory) {
    ...
    public boolean stillValid(Player player) {
        return access.evaluate((level, pos) -> level.getBlockEntity(pos) instanceof FurniWorkbenchBlockEntity, true);
    }
